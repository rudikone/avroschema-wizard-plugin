...
@DisplayName("All allowed Avro schema evolutions are compatible under FORWARD compatibility. Upgrade first: Producer")
class ForwardCompatibilityTest : BaseTaskTest() {
